	...
	function rating_kp_imdb(card) {
		...
		function _showRating(data) {
			if (data) {
				...
				// Добавляем иконки перед рейтингами
				var kp_icon = '<svg style="width:16px;height:16px;margin-right:5px;fill:#ffaa00" viewBox="0 0 24 24"><path d="M4.5 11H3V4h1.5v7m3 0H6V4h1.5v7m3 0H9V4h1.5v7m10.5 2c0 .7-.1 1.4-.3 2-.2.6-.4 1.1-.8 1.6-.3.5-.7.9-1.2 1.2-.5.3-1 .6-1.6.8-.6.2-1.3.3-2 .3-.7 0-1.4-.1-2-.3-.6-.2-1.1-.5-1.6-.8-.5-.3-.9-.7-1.2-1.2-.3-.5-.6-1-.8-1.6-.2-.6-.3-1.3-.3-2 0-1.1.2-2.1.7-3 .5-.9 1.1-1.6 1.9-2.1.8-.5 1.7-.8 2.7-.9.2 0 .5-.1.7-.1.2 0 .5 0 .7.1 1 .1 1.9.4 2.7.9.8.5 1.4 1.2 1.9 2.1.5.9.7 1.9.7 3m-1.5 0c0-.5-.1-1-.2-1.4-.1-.4-.3-.8-.5-1.2-.2-.3-.5-.6-.8-.8-.3-.2-.7-.4-1.1-.5-.4-.1-.9-.2-1.4-.2-.5 0-1 .1-1.4.2-.4.1-.8.3-1.1.5-.3.2-.6.5-.8.8-.2.3-.4.7-.5 1.2-.1.4-.2.9-.2 1.4 0 .5.1 1 .2 1.4.1.4.3.8.5 1.2.2.3.5.6.8.8.3.2.7.4 1.1.5.4.1.9.2 1.4.2.5 0 1-.1 1.4-.2.4-.1.8-.3 1.1-.5.3-.2.6-.5.8-.8.2-.3.4-.7.5-1.2.1-.4.2-.9.2-1.4z"/></svg>';
				var imdb_icon = '<svg style="width:16px;height:16px;margin-right:5px;fill:#f5c518" viewBox="0 0 24 24"><path d="M8.12 5.32 9.32 5v13.68l-1.2.68V5.32m7.6 0 1.2.68v13.68l-1.2.68V5.32M2 3v18h20V3H2m1 1h18v16H3V4z"/></svg>';
				
				$('.rate--imdb', render).removeClass('hide').find('> div').eq(0).html(imdb_icon + imdb_rating);
				$('.rate--kp', render).removeClass('hide').find('> div').eq(0).html(kp_icon + kp_rating);
			}
		}
	}
