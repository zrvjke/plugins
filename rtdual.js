(function() {
    ...
    Lampa.Plugin.register({
        id: PLUGIN_ID,
        name: 'Rotten Tomatoes + TMDb Toggle',
        version: '2.0.0',
        description: 'Добавляет рейтинги Rotten Tomatoes и позволяет скрыть TMDb рейтинг',
        type: 'modify',
        params: [
            {
                id: 'omdb_key',
    ...
    function addRatings(container, critics, audience) {
        const html = `
            <div class="rating rating--rt" style="display: flex; align-items: center; gap: 10px; margin-left: 15px;">
