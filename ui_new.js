...
(function () {
  ...
  // --------- seasons section killer ----------
  // Р—Р°РіРѕР»РѕРІРѕРє "РЎРµР·РѕРЅ N" РёР»Рё "Season N" (СЂСѓСЃ./Р°РЅРіР».). РЈРґР°Р»СЏРµРј Р±Р»РѕРє СЃРµР·РѕРЅРѕРІ РјРµР¶РґСѓ
  // РїСЂРѕРёР·РІРѕРґСЃС‚РІРѕРј/С‚РµРіР°РјРё Рё Р°РєС‚С‘СЂР°РјРё.
  var RE_SEASON_HEADING = /^(?:\u0421\u0435\u0437\u043e\u043d\s*\d+|Season\s*\d+)/i;

  /**
   * РЈРґР°Р»СЏРµС‚ СЃРµРєС†РёСЋ СЃ СЃРµР·РѕРЅР°РјРё РІ СЃРµСЂРёР°Р»Р°С…. РќР°С…РѕРґРёС‚ Р·Р°РіРѕР»РѕРІРѕРє "РЎРµР·РѕРЅ N" РёР»Рё
   * "Season N", РїРѕРґРЅРёРјР°РµС‚СЃСЏ Рє РµРіРѕ РєРѕРЅС‚РµР№РЅРµСЂСѓ СЃ РїРѕРјРѕС‰СЊСЋ climbToSection Рё
   * СЃРєСЂС‹РІР°РµС‚ СЌС‚РѕС‚ РєРѕРЅС‚РµР№РЅРµСЂ Рё РІСЃРµ РїРѕСЃР»РµРґСѓСЋС‰РёРµ СЃРѕСЃРµРґРЅРёРµ Р±Р»РѕРєРё РґРѕ С‚РµС… РїРѕСЂ, РїРѕРєР°
   * РЅРµ РІСЃС‚СЂРµС‚РёС‚ СЃРµРєС†РёСЋ Р°РєС‚С‘СЂРѕРІ. Р­С‚Рѕ РіР°СЂР°РЅС‚РёСЂСѓРµС‚, С‡С‚Рѕ СЃРєСЂС‹РІР°РµС‚СЃСЏ РІСЃСЏ СЃРµРєС†РёСЏ
   * СЃ СЃРµР·РѕРЅР°РјРё (Р·Р°РіРѕР»РѕРІРѕРє Рё СЂСЏРґ РєР°СЂС‚РѕС‡РµРє), РЅРѕ РЅРµ Р·Р°С‚СЂР°РіРёРІР°СЋС‚СЃСЏ Р°РєС‚С‘СЂС‹.
   *
   * @param {HTMLElement|Document} root РљРѕСЂРЅРµРІРѕР№ СЌР»РµРјРµРЅС‚ РґР»СЏ РїРѕРёСЃРєР°
   */
  function killSeasonSections(root){
    ...
    for (i = 0; i < nodes.length; i++){
      var node = nodes[i];
      var txt  = textOf(node);
      if (txt && RE_SEASON_HEADING.test(txt)){
        // РїРѕРґРЅРёРјР°РµРјСЃСЏ Рє СЂРѕРґРёС‚РµР»СЊСЃРєРѕРјСѓ РєРѕРЅС‚РµР№РЅРµСЂСѓ, СЃРѕРґРµСЂР¶Р°С‰РµРјСѓ СЃРµРєС†РёСЋ СЃРµР·РѕРЅР°
        var sec = climbToSection(node, 10);
        // СЃРєСЂС‹РІР°РµРј С‚РµРєСѓС‰РёР№ Р±Р»РѕРє Рё РІСЃРµ РµРіРѕ СЃР»РµРґСѓСЋС‰РёРµ СЃРѕСЃРµРґРё, РїРѕРєР° РЅРµ РЅР°С‚РєРЅС‘РјСЃСЏ РЅР° Р°РєС‚С‘СЂРѕРІ
        var cur = sec;
        var guard = 0;
        while (cur && guard++ < 20) {
          // РµСЃР»Рё СЌС‚Рѕ СЃРµРєС†РёСЏ Р°РєС‚С‘СЂРѕРІ вЂ” РїСЂРµРєСЂР°С‰Р°РµРј
          var h = null;
          if (cur.querySelector) {
            h = cur.querySelector('h1,h2,h3,h4,h5,h6,div,span');
          }
          if (h && RE_ACTORS.test(textOf(h))) {
            break;
          }
          hideNode(cur);
